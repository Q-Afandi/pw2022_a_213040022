            ...
            <div class="col-8">
                <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <!-- ini kalo buat yang text -->
                     <div class="row nb-3">
                    <label for="category" class="form-label">Category</label>
                    <input type="text" class="form-control" id="category" name="category" value="<?= $prod["category"] ?> ">
                    </div> 
                    ...
                    <input type="text" class="form-control" id="stok" name="stok" value="<?= $prod["stok"] ?> ">
                    </div>

                    <div class="row nb-3">
                    <label for="npm" class="form-label">Gambar</label>
                    <img src="img/<?= $prod['gambar']; ?>" width="40">
                    <input type="file" class="form-control" id="gambar" name="gambar">
                    </div>
                    
                    <button type="submit" class="btn btn-primary mt-2" name="edit">Edit Product</button>
